...
class ManageDomainGeneratorSettings extends BitflanSettingsPage
{
    protected static ?string $title                 = 'Domain Generator Settings';
    protected static bool $shouldRegisterNavigation = false;
    protected static ?string $navigationIcon        = 'heroicon-o-cog';

    protected static string $settings = DomainGeneratorSettings::class;
    ...
    protected function getFormSchema(): array
    {
        return [
            ...
            Components\Grid::make()->schema([
                Components\TextInput::make('title')->placeholder('Title of this Tool')->helperText('This appears as the title of this Tool.')->required()->columnSpan(2),
                ...
                Components\TextInput::make('affiliateUrl')->placeholder('Affiliate URL for the Buy Button')->helperText('User will be redirected to this URL on clicking the buy button. Use the {name} wildcard to specify the domain name.')->required()->columnSpan(2),
            ]),
